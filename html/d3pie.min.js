...
!(function(a, b) {
  'function' == typeof define && define.amd
    ? define([], b)
    : 'object' == typeof exports ? (module.exports = b()) : (a.d3pie = b(a));
})(this, function() {
  var a = 'd3pie',
    b = '0.2.1',
    c = 0,
    ...
    f = {
      initialCheck: function(a) {
        ...
        for (var e = [], f = 0; f < d.data.content.length; f++)
          'number' != typeof d.data.content[f].value || isNaN(d.data.content[f].value)
            ? console.log('not valid: ', d.data.content[f])
            : d.data.content[f].value <= 0
              ? console.log('not valid - should have positive value: ', d.data.content[f])
    ...
    g = {
      ...
      processObj: function(a, b, c) {
        return 'string' == typeof b
          ...
          : 1 === b.length && void 0 !== c
            ? ((a[b[0]] = c), a[b[0]])
            : 0 === b.length ? a : g.processObj(a[b[0]], b.slice(1), c);
      },
      ...
      initSegmentColors: function(a) {
        for (
          var b = a.options.data.content, c = a.options.misc.colors.segments, d = [], e = 0;
          e < b.length;
          e++
        )
      ...
      applySmallSegmentGrouping: function(a, b) {
        ...
        return (
          e.length &&
            d.push({ color: b.color, label: b.label, value: f, isGrouped: !0, groupedData: e }),
          d
        );
      },
    ...
    i = {
      ...
      calculatePieCenter: function(a) {
        ...
        c && d
          ...
          : c ? (e += a.textComponents.title.h) : d && (e += a.textComponents.subtitle.h);
        var f = 0;
    ...
    j = {
              ...
              return (
                e.formatter
                  ...
                  : e.truncation.enabled &&
                    ...
                    (c = a.label.substring(0, e.truncation.truncateLength) + '...'),
                c
              );
            })
      ...
      computeLinePosition: function(a, b) {
        var c,
          ...
          e,
          f,
          g = k.getSegmentAngle(b, a.options.data.content, a.totalSize, { midpoint: !0 }),
          h = i.rotate(
            a.pieCenter.x,
        ...
        'none' !== a.options.labels[b].format &&
          d3
            ...
            .attr('transform', function(c, d) {
              var e, f;
              if ('outer' === b)
                (e = a.outerLabelGroupData[d].x), (f = a.outerLabelGroupData[d].y);
              else {
      ...
      checkConflict: function(a, b, c, d) {
        ...
        if (!(1 >= d)) {
          ...
          if (
            !(('clockwise' === c && 'right' !== h) || ('anticlockwise' === c && 'left' !== h))
          ) {
      ...
      getIdealOuterLabelPositions: function(a, b) {
        ...
        if (c) {
          var d = c.getBBox(),
            e = k.getSegmentAngle(b, a.options.data.content, a.totalSize, { midpoint: !0 }),
            f = a.pieCenter.x,
          ...
          e > 180 ? ((h.x -= d.width + 8), (j = 'left')) : (h.x += 8),
            (a.outerLabelGroupData[b] = { x: h.x, y: h.y, w: d.width, h: d.height, hs: j });
        }
      }
    },
    k = {
      ...
      create: function(a) {
        ...
        'none' === d.effect && (j = 0),
          ...
          a.svg.selectAll('g.' + a.cssPrefix + 'arc').attr('transform', function(b, c) {
            var d = 0;
            return (
              c > 0 && (d = k.getSegmentAngle(c - 1, a.options.data.content, a.totalSize)),
              'rotate(' + d + ')'
            );
          }),
          (a.arc = g);
      ...
      maybeCloseOpenSegment: function() {
        d3.selectAll('.' + pie.cssPrefix + 'expanded').size() > 0 &&
          k.closeSegment(pie, d3.select('.' + pie.cssPrefix + 'expanded').node());
      },
    ...
    m = {
      ...
      moveTooltip: function(a) {
        d3
          .selectAll('#' + a.cssPrefix + 'tooltip' + m.currentTooltip)
    ...
    (n.prototype.openSegment = function(a) {
      (a = parseInt(a, 10)),
        0 > a ||
          ...
          k.openSegment(this, d3.select('#' + this.cssPrefix + 'segment' + a).node());
    }),
